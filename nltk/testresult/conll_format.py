...
for dom in domain:
	input = "/home/loharja/PhD/NEGES_2018/task2/corpus_SFU_Review_SP_NEG_task2/test/test_"+dom+"_task2.txt"
	input2 = "/home/loharja/PhD/NEGES_2018/task2/nltk/testresult/test_"+dom+"_task2_res.txt"
	...
	with open(input) as f, open(input2) as f2:
		...
		for line in f:
			if line != "\n":
				...
				o = words2[count].split("|")[0].split("$")[0]
